...
- Use `strix_finding (vulnerability_type=dependency_cve)` only for verified advisory-matched dependency CVEs. Use `strix_finding` for dynamically verified application, model, RAG, agent, or supply-chain findings.
