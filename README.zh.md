...
Strix 的 13+ 漏洞知识包（11 大类）改编为 dsh skills，随仓库发布在 `.dsh/skills/`，由 dsh 的 skill-filesystem provider 自动发现、经 `skill` 工具按需加载。详见 [docs/prompt-design.md](docs/prompt-design.md)。
